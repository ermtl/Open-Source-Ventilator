...
The controller now outputs data that can use an external HMI or the Arduino plotter to output realtime data. Actual plot below (the pink pressure trace was generated by manually pressing an ambu-bag. The right of the screen shows a pressure limited cycle).
